#!/usr/bin/env python3
"""
CT-DiffNet Training Script (Single Dataset, 60/20/20 Split)
======================================================
Task: Train and evaluate the CT-DiffNet model on a specific alloy dataset.
"""
...
# 3. User Parameters
# ==========================================
DATA_FILE = "cacheNi5Re_7mod.npz"

BATCH = 32
TRAIN_RATIO = 0.6
VAL_RATIO = 0.2
# TEST_RATIO is dynamically calculated as the remainder
...
def main():
    ...
    full_ds = SimpleBarrierDataset(DATA_FILE)
    ...
    print(f"Splitting into -> Train: {n_train} (60%), Val: {n_val} (20%), Test: {n_test} (20%)")
    ...
    base = CNNTransformer3D(
        in_channels=9, hidden_channels=128, num_cnn_blocks=1,
