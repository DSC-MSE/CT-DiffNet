#!/usr/bin/env python3
"""
CT-DiffNet Training Script (Multi-Dataset Training & Specific Evaluation)
======================================================
Task: Train the CT-DiffNet model on multiple binary subsystems and evaluate on a complex ternary test set.
"""
...
CHECKPOINT = "best_model_con_5Al5Re.pth"
